...
print('\n---------------------------\n')
new_known_word = input('If there is a word you actually already know, type it here to add it to the vocabulary.\n')
preprocessing.add_lemma_to_vocabulary(new_known_word, vocabulary_file_name)
print('n')
display.print_unknown_words_red(word_objects)
